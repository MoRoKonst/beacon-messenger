...
private val ru9 = object : IStr9 {
    ...
    override val panicButtonSubtitle = "Показывает уведомление с кнопкой вайпа, доступной без разблокировки. Нажимайте быстро, не считая нажатий — каждое засчитывается мгновенно."
